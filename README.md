...
| <a name="input_analyzer_enabled"></a> [analyzer\_enabled](#input\_analyzer\_enabled) | Boolean whether analyzer-baseline is enabled. | `bool` | `true` | no |
...
| <a name="input_cloudtrail_enabled"></a> [cloudtrail\_enabled](#input\_cloudtrail\_enabled) | Boolean whether cloudtrail-baseline is enabled | `bool` | `true` | no |
...
| <a name="input_iam_enabled"></a> [iam\_enabled](#input\_iam\_enabled) | Boolean whether iam-baseline is enabled. | `bool` | `true` | no |
...
| <a name="input_s3_baseline_enabled"></a> [s3\_baseline\_enabled](#input\_s3\_baseline\_enabled) | Boolean whether the S3 baseline module should be enabled | `bool` | `true` | no |
